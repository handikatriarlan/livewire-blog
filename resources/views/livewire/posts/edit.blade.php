    ...
    <div class="max-w-4xl w-full">
        <div class="mb-6 flex justify-between items-center">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update your blog post</p>
            </div>
                ...
                <form wire:submit="update" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1">
                            ...
                            @else
                                <div class="mb-4">
                                    <img src="{{ asset('/storage/posts/'.$oldImage) }}" alt="Current Image" class="w-full h-64 object-cover rounded-md">
                    ...
                    <div class="flex items-center justify-end space-x-3 pt-4">
                        <button type="submit" wire:loading.attr="disabled" wire:loading.class="opacity-75 cursor-not-allowed" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
                            <svg wire:loading wire:target="update" class="animate-spin -ml-1 mr-2 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <svg wire:loading.remove wire:target="update" xmlns="http://www.w3.org/2000/svg" class="-ml-1 mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
