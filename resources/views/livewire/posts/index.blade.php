                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center justify-center">
                                <img src="{{ asset('/storage/posts/'.$post->image) }}" class="h-24 w-24 object-cover rounded-md shadow-sm" alt="{{ $post->title }}">
                            </div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-500 dark:text-gray-300 line-clamp-3">{!! $post->content !!}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex space-x-2 justify-end">
                                ...
                                <button class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="flex items-center justify-center">
                                <div class="bg-red-50 dark:bg-red-900/20 rounded-md px-4 py-3 w-full">
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm font-medium text-red-800 dark:text-red-200">Data Post belum Tersedia.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
